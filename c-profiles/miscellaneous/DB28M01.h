...
#define DB28M01_BUILDER_VERSION_BUGFIX 9
#define DB28M01_BUILDER_VERSION_SUFFIX ""
#define DB28M01_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_DB28M01(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {68, 66, 50, 56, 77, 48, 49, 0, 49, 50, 45, 77, 69, 110, 49, 0, 0, 0, 0, 0, 0, 0, 0, 0};
