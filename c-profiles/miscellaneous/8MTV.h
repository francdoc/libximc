...
#define 8MTV_BUILDER_VERSION_BUGFIX 9
#define 8MTV_BUILDER_VERSION_SUFFIX ""
#define 8MTV_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MTV(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 86, 0, 51, 45, 49, 49, 50, 45, 77, 69, 110, 49, 0, 0, 0, 0, 0, 0, 0, 0, 0};
