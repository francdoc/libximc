...
#define 8MDS_70_BUILDER_VERSION_BUGFIX 9
#define 8MDS_70_BUILDER_VERSION_SUFFIX ""
#define 8MDS_70_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MDS_70(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 68, 83, 45, 55, 48, 0, 0, 50, 0, 0, 95, 49, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
