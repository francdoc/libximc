...
#define 8MID12_1_H_BUILDER_VERSION_BUGFIX 9
#define 8MID12_1_H_BUILDER_VERSION_SUFFIX ""
#define 8MID12_1_H_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MID12_1_H(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 49, 50, 45, 49, 45, 72, 0, 0, 95, 49, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
