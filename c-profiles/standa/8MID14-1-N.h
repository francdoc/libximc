...
#define 8MID14_1_N_BUILDER_VERSION_BUGFIX 9
#define 8MID14_1_N_BUILDER_VERSION_SUFFIX ""
#define 8MID14_1_N_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MID14_1_N(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 49, 52, 45, 49, 45, 78, 0, 0, 95, 49, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
