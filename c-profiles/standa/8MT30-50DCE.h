...
#define 8MT30_50DCE_BUILDER_VERSION_BUGFIX 9
#define 8MT30_50DCE_BUILDER_VERSION_SUFFIX ""
#define 8MT30_50DCE_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MT30_50DCE(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 51, 48, 45, 53, 48, 68, 67, 69, 0, 49, 0, 0, 0, 68, 67, 0, 0, 0, 0, 0, 0};
