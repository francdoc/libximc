...
#define 8MS00_25_BUILDER_VERSION_BUGFIX 9
#define 8MS00_25_BUILDER_VERSION_SUFFIX ""
#define 8MS00_25_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MS00_25(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 83, 48, 48, 45, 50, 53, 0, 50, 56, 0, 69, 110, 50, 45, 50, 48, 48, 0, 0, 0, 0, 0};
