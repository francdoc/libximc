...
#define 8MID20_12_AR_BUILDER_VERSION_BUGFIX 9
#define 8MID20_12_AR_BUILDER_VERSION_SUFFIX ""
#define 8MID20_12_AR_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MID20_12_AR(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 73, 68, 50, 48, 45, 49, 46, 50, 45, 65, 82, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
