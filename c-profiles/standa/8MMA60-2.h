...
#define 8MMA60_2_BUILDER_VERSION_BUGFIX 9
#define 8MMA60_2_BUILDER_VERSION_SUFFIX ""
#define 8MMA60_2_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MMA60_2(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 77, 65, 54, 48, 45, 50, 0, 0, 0, 0, 82, 0, 53, 0, 0, 0, 0, 0, 0, 0, 0, 0};
