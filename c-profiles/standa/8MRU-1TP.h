...
#define 8MRU_1TP_BUILDER_VERSION_BUGFIX 9
#define 8MRU_1TP_BUILDER_VERSION_SUFFIX ""
#define 8MRU_1TP_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MRU_1TP(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 82, 85, 45, 49, 84, 80, 0, 53, 45, 76, 69, 110, 50, 45, 50, 48, 48, 0, 0, 0, 0, 0};
