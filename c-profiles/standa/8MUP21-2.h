...
#define 8MUP21_2_BUILDER_VERSION_BUGFIX 9
#define 8MUP21_2_BUILDER_VERSION_SUFFIX ""
#define 8MUP21_2_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MUP21_2(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 85, 80, 50, 49, 45, 50, 0, 49, 55, 48, 0, 76, 69, 78, 45, 53, 48, 0, 0, 0, 0, 0};
