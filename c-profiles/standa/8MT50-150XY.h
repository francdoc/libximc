...
#define 8MT50_150XY_BUILDER_VERSION_BUGFIX 9
#define 8MT50_150XY_BUILDER_VERSION_SUFFIX ""
#define 8MT50_150XY_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MT50_150XY(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 53, 48, 45, 49, 53, 48, 88, 89, 0, 0, 77, 69, 110, 49, 0, 0, 0, 0, 0, 0, 0};
