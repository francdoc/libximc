...
#define 8MT60_200_BUILDER_VERSION_BUGFIX 9
#define 8MT60_200_BUILDER_VERSION_SUFFIX ""
#define 8MT60_200_BUILDER_VERSION        "0.9.9"
...
static inline result_t set_profile_8MT60_200(device_t id)
{
  ...
  const int8_t stage_information_PartNumber_temp[24] = {56, 77, 84, 54, 48, 45, 50, 48, 48, 0, 66, 83, 49, 0, 69, 110, 49, 0, 0, 0, 0, 0, 0, 0};
