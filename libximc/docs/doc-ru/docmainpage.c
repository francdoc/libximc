 ...
 *
 * \warning
 * Библиотека открывает контроллер в режиме эксклюзивного доступа.
 *
 ...
 *
 * Пожалуйста, прочитайтие <a href="https://libximc.xisupport.com/doc-ru/intro_sec.html">Введение</a> для начала работы с библиотекой.
 *
