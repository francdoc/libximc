 ...
 * Библиотека libximc использует распространенный и проверенный интерфейс виртуального последовательного порта, поэтому вы можете работать с модулями управления моторами через эту библиотеку практически под всеми ОС: Windows 11, Windows 10, Windows 8, Windows 7, Windows Vista, Windows XP SP3, Linux, Mac OS для intel и Apple Silicone (с использованием Rosetta 2), в том числе с 64-бит версиями.
 ...
 *
 * Для Windows:
 * - ОС Windows x64 (если планируется собирать обе архитектуры) или x32
