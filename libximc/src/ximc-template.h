...
/**
	...
	*/
	...
	/**
		...
		* Device uri has form "xi-com:port" or "xi-net://host/serial" or "xi-emu:///abs_path_to_file".
		...
		* Uri устройства имеет вид "xi-com:port" или "xi-net://host/serial" или "xi-emu:///abs_path_to_file".
