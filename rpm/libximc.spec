...
* Tue Jul 28 2020 XIMC <info@ximc.ru> - 2.10.8
- version bump
- Bug #28368 Modify testcs to support new versions of .NET

* Mon Apr 13 2020 XIMC <info@ximc.ru> - 2.10.7
- version bump
- Changing the Protocol version 18.5
- Feature #37941 Remove the change_motor command from libximc

* Tue Oct 29 2019 XIMC <info@ximc.ru> - 2.10.6
- version bump
- Encoder mediated added
- Feature #27186 Moved the folder with the drivers
