...
4. The library with dependencies is located in the ximc/win * * folders. For the example to work, you need the following files: libximc.dll, xibridge.dll.
...
4. Библиотека с зависимостями расположена в папках ximc/win**. Для работы примера необходимы файлы: libximc.dll, xibridge.dll.
