Eng. To work this example copy files ximc.pas, libximc.dll, xiwrapper.dll and bindy.dll from ximc folder next to test_Delphi.dpr
...
Ru. Для работы примера скопируйте файлы ximc.pas, libximc.dll, xiwrapper.dll и bindy.dll из папки ximc рядом с test_Delphi.dpr
