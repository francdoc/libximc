Eng. To work this example copy files ximc.pas, libximc.dll, xibridge.dll from ximc folder next to test_Delphi.dpr
...
Ru. Для работы примера скопируйте файлы ximc.pas, libximc.dll, xibridge.dll из папки ximc рядом с test_Delphi.dpr
