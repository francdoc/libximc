...
examples/testcodeblocks. Install gcc compatible with CodeBlocks.
...
2. To build and run, open the examples/testcodeblocks/testcodeblocks.cbp project in CodeBlocks. Build and run the application from the development environment.
...
examples/testcodeblocks. Установите gcc, совместимый с CodeBlocks.
...
2. Для сборки и запуска откройте проект examples/testcodeblocks/testcodeblocks.cbp в CodeBlocks. Выполните сборку и запустите приложение из среды разработки.
