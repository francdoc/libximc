...
4. The library with dependencies is located in the ximc/win** folders. For the example to work, you need the following files: xibridge.dll, libximc.dll.
...
4. Библиотека с зависимостями расположена в папках ximc/win**. Для работы примера необходимы файлы: xibridge.dll, libximc.dll.
