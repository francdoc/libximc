...
static inline result_t set_profile_8MT173_25(device_t id)
{
  ...
  stage_settings.VerticalLoadCapacity = 2;
  ...
  const int8_t motor_information_Manufacturer_temp[16] = {78, 97, 110, 111, 116, 101, 99, 0, 111, 110, 116, 114, 111, 108, 32, 80};
  memcpy(motor_information.Manufacturer, motor_information_Manufacturer_temp, sizeof(int8_t) * 16);
  const int8_t motor_information_PartNumber_temp[24] = {83, 84, 50, 56, 49, 56, 77, 49, 48, 48, 54, 0, 66, 0, 72, 86, 0, 50, 48, 48, 45, 88, 0, 0};
  ...
  const int8_t encoder_information_PartNumber_temp[24] = {0, 69, 68, 77, 45, 53, 53, 48, 48, 0, 32, 84, 121, 112, 101, 32, 83, 0, 0, 0, 0, 0, 0, 0};
